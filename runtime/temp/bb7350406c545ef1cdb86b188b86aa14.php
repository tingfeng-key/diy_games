<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\learn_work_space\diy_games\public/../application/game\view\makes\erlingsiba.html";i:1482909865;s:80:"F:\learn_work_space\diy_games\public/../application/game\view\Common\layout.html";i:1478250927;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<style>
    ...
    @media screen and (min-width:560px){
        #addReward {
            background-image: url(__IMG__/2048/add.png);
            background-size: 100%;
            height: 5rem;
    ...
    @media screen and (min-width:560px){
        #delReward {
            background-image: url(__IMG__/2048/delete.png);
            background-size: 100%;
            height: 5rem;
            background-repeat: no-repeat;
        }
    ...
    <form class="form" v-on:submit.prevent>
        ...
        <section class="group">
            <section class="headImage">
                ...
                <section class="right" style="margin-top: -0.5rem;">
                    <sction class="title">第二步：颜色模式</sction>
                    <hr />
                    <h3 class="tips">四种颜色模式，随意选择！</h3>
                </section>
            </section>
            <section class="row content tC">
                ...
                <section class="tC colorBtnGroup">
                    <input type="hidden" name="color" value="{{ color_img }}" />
        ...
        <section class="group">
            <section class="headImage">
                <section class="left">
                    <img src="__IMG__/2048/headImage_2.png" >
                </section>
                <section class="right" style="margin-top: 0.3rem;">
                    <sction class="title">第三步：字体替换</sction>
                    <hr />
                    <h3 class="tips">点击按钮可以设置新字体哦！</h3>
                </section>
            </section>
            <section class="content">
                <section class="row">
                    <section class="col-xs-6">
                        <section>
                            <img class="color" src="__IMG__/2048/font_微软雅黑.png" />
                        </section>
                        <section class="tips_font">
                            替换前
                        </section>
                    ...
                    <section class="col-xs-6">
                        <section>
                            <img class="color" id="font_img" src="__IMG__/2048/font_{{ font_img }}.png" />
                        </section>
                        <section class="tips_font">
                            替换后
                        </section>
                ...
                <section class="clear tC fontBtnGroup">
                    <input type="hidden" name="font" value='{{ font_img }}' />
                    <button v-on:click="fontEvent(item.name)"
                            v-for="item in fontItem"
                            v-bind:class="{ fontBtn: !item.selected, fontBtnCheck: item.selected}"
                            class="fontBtns">
                        <img src="__IMG__/2048/font_1_{{ item.name }}.png">
                    </button>
                    <section style="font-size: 2rem;margin-top: 1rem;">
                        <span style="color:red">*</span> 上面这些按钮是可以点击的哦~！
                    </section>
...
<script src="__JS__/vue_erlingsiba.js"></script>
