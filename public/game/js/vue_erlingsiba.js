...
var layer,
    ...
    created: function(){
        ...
        this.color_img = data.color;
        this.colorEvent(data.color);
        this.font_img = data.font;
        this.fontEvent(data.font);
    ...
    methods: {
        ...
        fontEvent: function(num){
            this.font_img = num;
            this.fontItem[this.fontDefaultEvent(num)].selected = true;
        },
        fontDefaultEvent: function(val){
            var index;
            for(var i = 0; i < this.fontItem.length; i++){
                if(val == this.fontItem[i].name){
                    index = i;
                }
                this.fontItem[i].selected = false;
            }
            return index;
        },
